...
<CompareText :keys="['graphemes.ascii', 'graphemes.emojiSimple', 'graphemes.emojiZwj', 'graphemes.devanagari', 'graphemes.mixed']" vs="intlSegmenter" />, <CompareText :keys="['graphemes.ascii', 'graphemes.emojiSimple', 'graphemes.emojiZwj', 'graphemes.devanagari', 'graphemes.mixed']" vs="graphemer" />.
